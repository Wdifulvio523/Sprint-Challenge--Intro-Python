...
# create letters list to check against
letters =["C", "D", "E", "F", "G"]
# use startswith method and tuple of letters
c = [x.name for x in humans if x.name.startswith(tuple(letters))]
print(c)
...
g = [Human(param.name.upper(), param.age + 5) for param in humans]
print(g)
